...
CREATE TABLE Buyer_Company (
    ...
    CONSTRAINT chk_company_phone       CHECK (phone ~ '^\+?[0-9]{7,15}$'),
...
CREATE TABLE Product (
    ...
    CONSTRAINT chk_product_name  CHECK (length(btrim(name)) > 0),
...
CREATE TABLE Invoice_Product (
    ...
    CONSTRAINT chk_invoice_product_quantity CHECK (quantity BETWEEN 1 AND 1000000),
